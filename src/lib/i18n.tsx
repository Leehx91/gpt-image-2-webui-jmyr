...
const en = {
    ...
    'settings.baseUrlHelp': 'Requests use the JmyR gateway. Billing follows the API key in your JmyR console.',
    ...
    'home.kicker': 'JmyR Image Gateway',
...
const zh: Translations = {
    ...
    'settings.baseUrlPlaceholder': 'https://www.jmyr.net/v1',
    'settings.baseUrlHelp': '请求默认走 JmyR 网关，扣费以控制台 API Key 的实际记录为准。',
    'settings.apiKey': 'JmyR API Key',
    'settings.apiKeyPlaceholder': 'sk-...',
