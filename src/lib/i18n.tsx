...
const en = {
    ...
    'settings.dark': 'Dark',
    'settings.api': 'API',
    'settings.baseUrl': 'JmyR gateway',
    'settings.baseUrlPlaceholder': 'https://www.jmyr.net/v1',
    'settings.baseUrlHelp': 'Billing follows the API key records in your JmyR console.',
    'settings.apiKey': 'JmyR API Key',
    'settings.apiKeyPlaceholder': 'sk-...',
    'settings.apiKeyHelp': 'Use an API key from your JmyR console.',
    ...
    'home.kicker': 'JmyR Creative Tools',
    'home.title': 'JmyR Image Workspace',
    'home.apiKeyHelp': 'Saved only in this browser. Requests are billed by your JmyR API key.',
    'home.modelHelp': 'Only JmyR-supported image models are available here.',
    'home.getApiKey': 'Open Keys',
    'home.getApiKeyAria': 'Open JmyR keys in a new tab',
    ...
    'apiInfo.empty': 'Run a generation to see the request status.',
    ...
    'form.edit.description': 'Upload reference images, then describe the change you want.',
    'form.edit.promptPlaceholder': 'e.g., Add a party hat to the main subject',
    'form.edit.title': 'Image to Image',
    ...
    'promptOptimizer.title': 'Prompt assistant',
    ...
    'promptOptimizer.editableHint': 'You can edit this draft directly before using it.',
    'promptOptimizer.iterateTitle': 'Keep refining',
    'promptOptimizer.iteratePlaceholder': 'e.g. cleaner background, more premium, keep the same composition',
    'promptOptimizer.iterate': 'Refine again',
    'promptOptimizer.iterateHint': 'Refines the editable draft above according to your adjustment.',
    ...
    'form.sizeTierGroup': '1. Choose resolution',
    'form.sizeRatioGroup': '2. Choose aspect',
    'form.sizeSummaryLabel': 'Current output',
    ...
    'form.sizeCustomAction': 'Use custom width and height',
    'form.sizeCustomDescription': 'Enter exact width and height',
    'form.sizeCustomSelected': 'Custom size is enabled',
...
const zh: Translations = {
    ...
    'settings.dark': '深色',
    'settings.api': 'API',
    'settings.baseUrl': 'JmyR 网关',
    'settings.baseUrlPlaceholder': 'https://www.jmyr.net/v1',
    'settings.baseUrlHelp': '扣费以控制台 API Key 的实际记录为准。',
    'settings.apiKey': 'JmyR API Key',
    'settings.apiKeyPlaceholder': 'sk-...',
    'settings.apiKeyHelp': '请使用 JmyR 控制台创建的 API Key。',
    ...
    'home.kicker': 'JmyR Creative Tools',
    'home.title': 'JmyR 图片工作台',
    'home.apiKeyHelp': '仅保存到当前浏览器；请求会按你的 JmyR API Key 扣费。',
    'home.modelHelp': '这里只展示 JmyR 当前支持的图片模型。',
    'home.getApiKey': '打开密钥',
    'home.getApiKeyAria': '在新标签页打开 JmyR API 密钥页面',
    ...
    'form.edit.description': '上传参考图，再描述你想要的变化。',
    ...
    'promptOptimizer.editableHint': '这里可以直接编辑，不满意就先改一改再使用。',
    'promptOptimizer.iterateTitle': '继续调整',
    'promptOptimizer.iteratePlaceholder': '例如：背景更干净、更高级、保留原构图',
    'promptOptimizer.iterate': '继续优化',
    'promptOptimizer.iterateHint': '会基于上面的可编辑优化稿继续微调。',
    ...
    'form.sizeRatioGroup': '2. 选择画幅',
    'form.sizeSummaryLabel': '当前输出',
    ...
    'form.sizeCustomAction': '使用自定义宽高',
    'form.sizeCustomDescription': '手动输入宽高',
    'form.sizeCustomSelected': '已启用自定义尺寸',
